...
function b(e, t = d) {
    ...
    function o(a) {
        if (v(e, a) && (e = a, n)) {
            const u = !c.length;
            for (const i of s) i[1](), c.push(i, e);
            if (u) {
    ...
    function l(a, u = d) {
        const i = [a, u];
        return s.add(i), s.size === 1 && (n = t(o) || d), a(e), () => {
            s.delete(i), s.size === 0 && (n(), n = null)
        }
    }
    return {
        set: o,
...
function O(e, t) {
    ...
    const s = {
        ...
        o = !n || k(n, t) || s.rel_external || s.target || s.download;
    return {
        url: n,
        has: s,
        external: o
...
function V(e) {
    let t = null,
        ...
        o = null,
        r = e;
    for (; r && r !== document.documentElement;) n === null && (n = f(r, "preload-code")), s === null && (s = f(r, "preload-data")), t === null && (t = f(r, "noscroll")), o === null && (o = f(r, "reload")), r = E(r);
    return {
...
function R() {
    ...
    async function s() {
        clearTimeout(n);
        const o = await fetch(`${m}/_app/version.json`, {
            headers: {
                pragma: "no-cache",
        ...
        if (o.ok) {
            const l = (await o.json()).version !== w;
...
export {
    S as I, _ as P, A as S, O as a, V as b, U as c, I as d, N as e, L as f, T as g, y as h, k as i, $ as s
};